...
router.get(
	...
	asyncHandler(async (req, res) => {
		return new SuccessResponse({
			data: await UserService.getPaginated(req.query)
		}).send(res)
	}))
...
router.get(
	...
	asyncHandler(async (req, res) => {
		return new SuccessResponse({
			data: await UserService.getDetail(req.params.id)
		}).send(res)
	}))
...
router.put(
	...
	asyncHandler(async (req, res) => {
		return new SuccessResponse({
			data: await UserService.update({ userId: req.params.id, ...req.body })
		}).send(res)
	}))
